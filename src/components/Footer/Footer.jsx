    ...
    <div>
      <footer>
        <div className="opening-hours">
          ...
          <p>De segunda a sexta das 09h as
        ...
        <figure className="social-media">
          <a href="https://instagram.com/waterlifeaquarismo?igshid=OGQ5ZDc2ODk2ZA==">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="black" className="bi bi-whatsapp" viewBox="0 0 16 16">
          ...
          <a href="https://www.facebook.com/waterlifeaquarismo?mibextid=LQQJ4d">
